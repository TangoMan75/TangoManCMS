...
class AdminCommand extends ContainerAwareCommand
{
    ...
    {
        $this->setName('tangoman:user:admin')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $roleSuperAdmin = $em->getRepository('UserBundle:Role')->findOneBy(['type' => 'ROLE_SUPER_ADMIN']);
        $superAdmin = $em->getRepository('UserBundle:User')->findBy(['role' => $roleSuperAdmin]);
